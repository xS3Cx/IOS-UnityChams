...
// MemoryInfo structure like in dumper
struct MemoryInfo {
    uint32_t index;
...
namespace IL2Cpp 
{
    // Global info variable like in dumper
    ...
    extern void* (*il2cpp_image_get_class)(void* image, size_t index);
    extern size_t (*il2cpp_image_get_class_count)(void* image);
    ...
    extern const char* (*il2cpp_field_get_type)(void* field);
